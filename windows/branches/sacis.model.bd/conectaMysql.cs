...
namespace sacis.model.bd
{
    public class conectaMysql
    {
        ...
        private static string DADOS_CONEXAO = @"Persist Security info=False; server=localhost; database=bdsacis; uid=root; pwd='123';"; //database=bdsacis; iud=sacis; pwd='q1w2e3r4'; --> para conectar no servidor web
